 ...
 *
 * Defines how to interact with different CLI tools via a session manager.
 */
...
export interface CLIAdapter {
   ...
   *
   * When a tool is detected, stall detection is suppressed and a `tool_running`
   * event is emitted so the UI can display the active tool.
   *
