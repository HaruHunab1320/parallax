 ...
 * Use these to clean raw PTY output before presenting it to coordinating
 * agents or humans.
 *
 * @module ansi-utils
 */
...
/**
 * Clean terminal output for display in chat messages or for coordinating agents.
 *
 ...
 *
 * Use this when a coordinating agent needs to read sub-agent output without
 * wading through TUI noise.
 */
