...
export const templateCommand = new Command('template')
  ...
  .addCommand(
    new Command('list').description('List available templates').action(() => {
      ...
      Object.entries(templates).forEach(([name, template]) => {
        ...
        console.log(
          chalk.gray(`    Primitives: ${template.defaultPrimitives.join(', ')}`)
        );
        console.log();
      });
    })
  ...
  .addCommand(
    new Command('show')
      ...
      .action((name) => {
        ...
        console.log(
          chalk.gray('Default Confidence:'),
          template.defaultConfidence
        );
        console.log(
          chalk.gray('Primitives:'),
          template.defaultPrimitives.join(', ')
        );
