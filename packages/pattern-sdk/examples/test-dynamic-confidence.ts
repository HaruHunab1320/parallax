      ...
      return {
        object: {
          selected: [
            {
              name: 'parallel',
              reason: 'Execute agents in parallel',
              config: {},
            },
            {
              name: 'consensus',
              reason: 'Build consensus from results',
              config: {},
            },
          ],
...
async function testDynamicConfidence() {
  ...
  console.log(
    '1. Agents execute in parallel - confidence extracted from each response'
  );
  ...
  console.log(
    '4. Confidence flows through the pattern based on actual execution'
  );
}
