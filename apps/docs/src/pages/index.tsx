    ...
    <Layout title={siteConfig.title} description={siteConfig.tagline}>
        ...
        <div className="container">
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSubtitle}>
              Orchestrate reliable multi-agent systems with measurable
              confidence.
            </p>
          </div>
      ...
      <section className={styles.installSection}>
        <div className={styles.installContent}>
          ...
          <p>Install the SDK, run your first pattern, and scale as you grow.</p>
          <div className={styles.heroButtons}>
            <Link
              className={clsx('button', styles.primaryButton)}
              to="/docs/getting-started/quickstart"
            ...
            <Link
              className={clsx('button', styles.ghostButton)}
              to="https://github.com/HaruHunab1320/parallax"
            >
              GitHub
            </Link>
          </div>
